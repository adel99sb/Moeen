...
namespace Moeen.Api.Core.Contracts.Application
{
    public interface IExamHalqaService
    {
        ...
        Task<CreateExamTeacherResponse> CreateAsync(CreateExamTeacherRequest request);
        ...
        Task<GetExamTeacherByIdResponse> GetByIdAsync(GetExamTeacherByIdRequest request);
        ...
        Task<AssignHalqaResponse> AssignHalqaAsync(AssignHalqaToExamTeacherRequest request);
    }
}
